    ...
    <section className="py-20 md:py-28 bg-white relative overflow-hidden">
      ...
      <div className="container-wide relative">
        <div className="max-w-3xl mx-auto text-center px-4 sm:px-0">
          <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-4 md:mb-6 animate-fade-in-up">
            Ready to Start Your{" "}
            <span className="text-gold italic">European</span> Journey?
          </h2>

          <p className="text-foreground/70 text-base sm:text-lg md:text-xl mb-8 md:mb-10 max-w-2xl mx-auto animate-fade-in-up animation-delay-200">
            Take the first step today. Our experts are ready to guide you
            towards your European dream with personalized consultation.
          </p>

          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center animate-fade-in-up animation-delay-300">
            <Link
              to="/contact"
          ...
          <p className="text-foreground/50 text-xs sm:text-sm mt-6 md:mt-8 animate-fade-in-up animation-delay-400">
