...
const footerLinks = {
  ...
  services: [
    { name: "Basic Package", path: "/services" },
    { name: "Custom Package", path: "/services" },
...
export function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground">
      {/* Main Footer */}
      <div className="container-wide py-12 sm:py-16 md:py-20 px-4 sm:px-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/70 text-xs sm:text-sm leading-relaxed mb-4 sm:mb-6">
              Your trusted partner for European travel and hospitality. We make
              your European dreams a reality with expert guidance and
            ...
            <div className="flex gap-3 sm:gap-4">
              <a
                ...
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-gold hover:text-primary transition-all duration-200"
                aria-label="Facebook"
              >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading text-base sm:text-lg font-semibold mb-4 sm:mb-6">Quick Links</h4>
            <ul className="space-y-2 sm:space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.path}
                    className="text-primary-foreground/70 hover:text-gold transition-colors duration-200 text-xs sm:text-sm"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          {/* Services Links */}
          <div>
            <h4 className="font-heading text-base sm:text-lg font-semibold mb-4 sm:mb-6">Services</h4>
            <ul className="space-y-2 sm:space-y-3">
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <span className="text-primary-foreground/70 text-xs sm:text-sm">
                  123 European Way, Berlin, Germany 10115
                </span>
              </li>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container-wide py-4 sm:py-6 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4 px-4 sm:px-0">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            <Link
              to="/privacy"
              className="text-primary-foreground/50 hover:text-primary-foreground text-xs sm:text-sm transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
