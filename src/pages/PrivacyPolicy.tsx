                                    ...
                                    <div className="relative overflow-hidden bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] p-8 md:p-10 rounded-[2rem] mt-12 text-center border border-white/80 shadow-[0_15px_30px_-10px_rgba(0,0,0,0.06)]">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex flex-col md:flex-row gap-4 justify-center items-stretch max-w-3xl mx-auto">
                                                {/* Email Card */}
                                                <a href="mailto:privacy@europecalling.co" className="group flex-1 bg-white p-5 rounded-xl shadow-sm hover:shadow-md border border-gray-100 hover:border-gold/30 transition-all duration-300 flex items-center gap-4 text-left relative overflow-hidden">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <p className="text-primary font-bold text-base leading-none group-hover:text-gold transition-colors">privacy@europecalling.co</p>
                                                    </div>
                                                </a>
